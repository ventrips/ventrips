...
import {
  ...
  faToggleOn, faToggleOff, faSync, faEye, faLongArrowAltUp, faLongArrowAltDown, faStar, faChartLine
...
const icons = [
  ...
  faSync, faEye, faHotjar, faLongArrowAltUp, faLongArrowAltDown, faStar, faChartLine, faInfoCircle
];
