...
export class StocksComponent implements OnInit {
  ...
  getStocks(): Observable<any> {
    return this.http.get(`${environment.apiUrl}/getStocks?minPrice=0.01&maxPrice=100&sortByFields=yahooFinance,regularMarketVolume&minVolume=2000000&volumeHasMultipliedBy=0&externalSources=false&statsOnly=true&showHoldings=true`)
